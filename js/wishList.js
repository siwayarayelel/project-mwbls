...
function removeWishlist() {
  let wishRemove = document.getElementById("item-container");
  wishRemove.remove();
}

function removeWishlist1() {
  let wishRemove = document.getElementById("item-container1");
  wishRemove.remove();
}

function removeWishlist2() {
  let wishRemove = document.getElementById("item-container2");
  wishRemove.remove();
}

function removeWishlist3() {
  let wishRemove = document.getElementById("item-container3");
  wishRemove.remove();
}